...
**Note sur les coûts** : aucun budget n'est avancé dans cette feuille de route. Les coûts dépendent des versions logicielles en place, des intégrateurs disponibles, du volume de transactions et de la complexité réelle des flux — autant d'éléments non connus à ce stade. Chaque chantier nécessite un cadrage et un devis avant engagement. Le gain de "1,5 ETP/semaine" annoncé dans la synthèse est un ordre de grandeur optimiste et non mesuré — le gain réel ne sera quantifiable qu'après mise en production de chaque brique.
